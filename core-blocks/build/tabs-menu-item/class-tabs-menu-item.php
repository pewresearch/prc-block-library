 ...
 * @package PRC\Platform\Blocks
 */
class Core_Block_Tabs_Menu_Item {
	...
	public function init( $loader = null ): void {
		if ( null !== $loader ) {
			$loader->add_action( 'init', $this, 'register_block_core_tabs_menu_item' );
		}
	}
	 ...
	 */
	public function block_core_tabs_menu_item_render_callback( array $attributes, string $content, \WP_Block $block ): string {
	 ...
	 * @since 6.9.0
	 */
	public function register_block_core_tabs_menu_item() {
		register_block_type_from_metadata(
			PRC_BLOCK_LIBRARY_DIR . '/core-blocks/build/tabs-menu-item',
			array(
				'render_callback' => array( $this, 'block_core_tabs_menu_item_render_callback' ),
			)
		);
	}
}
