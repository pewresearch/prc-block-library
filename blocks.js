const files = [
	{
		...
		entry: {
			...
			'chart-builder-wrapper': './src/chart-builder-data-wrapper/index.js',
			...
			'topic-index-az-controller': './src/topic-index-az-controller/index.js',
			...
			'topic-index-condensed-menu': './src/topic-index-condensed/menu/index.js',
			'topic-index-condensed-menu-item':
				'./src/topic-index-condensed/menu-item/index.js',
			'topic-index-condensed-page': './src/topic-index-condensed/page/index.js',
			'topic-index-condensed-pages':
				'./src/topic-index-condensed/pages/index.js',
			'topic-index-search-field': './src/topic-index-search-field/index.js',
		},
	...
	},
	{
		...
		entry: {
			...
			'chart-builder-wrapper': './src/chart-builder-data-wrapper/frontend.js',
			...
			'topic-index-categorized': './src/topic-index-categorized/frontend.js',
			'topic-index-condensed':
				'./src/topic-index-condensed/controller/frontend.js',
			'topic-index-search-field': './src/topic-index-search-field/frontend.js',
		},
		optimizeForGutenberg: true,
	},
	{
