...
class Form_Input_Select {
	...
	public function construct_options_list( $attributes, $block ) {
		...
		if ( 'countries' === $type ) {
			...
			$input_options = \PRC\Primitives\BlockUtils\get_list_of( 'countries' );
		} elseif ( 'countries-and-regions' === $type ) {
			$input_options = \PRC\Primitives\BlockUtils\get_list_of( 'countries-and-regions' );
		} elseif ( 'us-states' === $type ) {
			$input_options = \PRC\Primitives\BlockUtils\get_list_of( 'us-states' );
		} elseif ( 'industries' === $type ) {
			$input_options = \PRC\Primitives\BlockUtils\get_list_of( 'industries' );
		}
