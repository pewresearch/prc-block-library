...
(async () => {
	...
	console.log(`Building ${isInteractive ? 'Interactive' : 'Non-Interactive'} Block`);
	...
	command += '; npx wp-scripts build-blocks-manifest --input=./src --output=./build/blocks-manifest.php';
