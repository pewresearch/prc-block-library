 ...
 *
 * This filter is only registered when the AI feature is enabled,
 * so the block's own code remains completely unaware of this feature.
 */
const withAIGenerateTable = createHigherOrderComponent((BlockEdit) => {
	return (props) => {
...
addFilter(
	'editor.BlockEdit',
	'prc-block-library/ai-features/generate-tabular-data',
	withAIGenerateTable
);
