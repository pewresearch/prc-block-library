...
class Interactivity_API {
	/**
	 * Handle for the interactivity api.
	 *
	 * @var string
	 */
	...
	/**
	 * Version of the interactivity api.
	 *
	 * @var string
	 */
	public $version;
	 ...
	 * @param mixed $metadata Metadata for the block.
	 * @return mixed
	 */
	 ...
	 * @param mixed $settings Settings for the block.
	 * @param mixed $metadata Metadata for the block.
	 * @return mixed
	 */
	public function add_settings( $settings, $metadata ) {
