	...
	const apiMethods = useMemo(() => {
		return registeredForms
			.filter(
				(form) =>
					form.method === 'api' &&
					[rootBlockNamespace, 'prc-block/form'].includes(
						form.namespace
					)
			)
			.map((form) => ({
			...
			<InspectorControls>
				<PanelBody title={__('Form Settings')}>
					...
					<TextControl
						...
						help={__(
							'This can be a URL, an email address, or any other value you want to pass to the end of form submission action. More often than not, this is a URL to redirect to after the form has been submitted. You can pass values in the form of %field_name% to insert the value of a form field into the URL. For example, if you want to redirect to a page that displays the value of the "name" field, you can use %name% in the URL.'
						)}
					/>
					{hasMessageBlock && (
						<Button
