...
/**
 * Server-side rendering of the `prc-block/form-input-text` block.
 *
 * @package gutenberg
 */

class Form_Input_Text extends PRC_Block_Library {
	public static $block_name = 'prc-block/form-input-text';
	...
	public function register_block() {
		...
		register_block_type_from_metadata(
			plugin_dir_path( __DIR__ ) . '/form-input-text',
			array(
