...
/**
 * Server-side rendering of the `prc-block/share-content` block.
 *
 * @package gutenberg
 */

class Share_Content extends PRC_Block_Library {
	...
	public function register_block() {
		...
		register_block_type_from_metadata(
			plugin_dir_path( __DIR__ ) . '/share-content',
			array(
