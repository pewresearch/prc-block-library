...
class Taxonomy_Index_AZ_List {
	...
	public function render_block_callback( $attributes, $content ) {
		...
		<div <?php echo $block_wrapper_attrs; ?>>
			<?php
			if ( array_key_exists( 'disableHeading', $attributes ) && true !== $attributes['disableHeading'] ) {
	...
	public function block_init() {
		register_block_type_from_metadata(
			PRC_BLOCK_LIBRARY_DIR . '/build/taxonomy-index-az-list',
			array(
