...
class Topic_Index_Condensed_Page extends PRC_Block_Library {
	...
	public function render_page_placeholder( $attributes, $content, $block ) {
		...
		<div class="wp-block-prc-block-topic-index-condensed-page" data-uuid="<?php echo esc_attr( $attributes['uuid'] ); ?>">
			<h2 class="sans-serif"><a href="<?php echo esc_url( $attributes['url'] ); ?>"><?php echo filter_block_kses_value( $attributes['heading'], 'post' ); ?> <i class="chevron right small icon"></i></a></h2>
