...
class Topic_Index_Condensed_View extends PRC_Block_Library {
	 ...
	 * @return string|false
	 */
	public function render_view_placeholder( $attributes, $content, $block ) {
		ob_start();
		?>
	...
	public function register_block() {
		...
		register_block_type_from_metadata(
			...
			array(
				...
				'render_callback' => array( $this, 'render_view_placeholder' ),
			)
		);
	}
}

new Topic_Index_Condensed_View( true );
