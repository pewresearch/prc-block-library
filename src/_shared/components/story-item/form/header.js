...
const Controls = ({ size, setAttributes }) => {
    ...
    return (
        <Fragment>
            <Item.Meta>
                ...
                {false === setAttributes && (
                    <KickerDisplay label={label} date={date} />
                )}
            </Item.Meta>
            <Item.Header className={classes}>
                ...
                {false === setAttributes && <RawHTML>{title}</RawHTML>}
            </Item.Header>
        </Fragment>
    );
};
