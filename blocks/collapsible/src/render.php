...
$title = array_key_exists( 'title', $attributes ) ? $attributes['title'] : 'How we did this';
...
echo wp_sprintf(
	...
	$is_deprecated ? 'class="is-style-plus wp-block-prc-block-collapsible"' : get_block_wrapper_attributes(array('id' => sanitize_title($title))),
	$title,
	$content,
);
