...
/* harmony export */   TaxonomyTermControl: () => (/* binding */ TaxonomyTermControl),
...
const ComboControl = (0,_emotion_styled__WEBPACK_IMPORTED_MODULE_2__["default"])('div')``;
function TaxonomyTermControl({
  attributes,
  setAttributes
}) {
  const {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(ComboControl, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_prc_components__WEBPACK_IMPORTED_MODULE_1__.TaxonomySelect, {
    value: taxonomy,
  ...
  }), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_prc_components__WEBPACK_IMPORTED_MODULE_1__.TermSelect, {
    maxTerms: 1,
    value: (0,lodash__WEBPACK_IMPORTED_MODULE_5__.has)(restrictToTerm, 'name') ? [{
...
function Controls({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.InspectorControls, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
    title: "Taxonomy Controls"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(TaxonomyTermControl, {
...
/* harmony import */ var _controls__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./controls */ "./src/controls.jsx");
...
function Edit({
  ...
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useInnerBlocksProps)(blockProps, {
    ...
    templateLock: true,
    template: [['prc-block/form-input-text', {
      isInteractive: true,
      interactiveNamespace: 'prc-block/taxonomy-search',
      placeholder: `Search ${taxonomy}`
    }]]
  });
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_controls__WEBPACK_IMPORTED_MODULE_2__["default"], {
    attributes,
    setAttributes,
    context,
    clientId
...
module.exports = /*#__PURE__*/JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":3,"name":"prc-block/taxonomy-search","version":"0.1.0","title":"Taxonomy Search","category":"theme","description":"Search for terms of a specified taxonomy.","icon":"search","attributes":{"taxonomy":{"type":"string","default":"category"},"restrictToTerm":{"type":"object"}},"supports":{"anchor":true,"html":false,"spacing":{"padding":true,"margin":true},"typography":{"fontSize":true,"lineHeight":true,"__experimentalFontFamily":true},"interactivity":true},"textdomain":"taxonomy-search","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css","render":"file:./render.php","viewScriptModule":"file:./view.js"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = globalThis["webpackChunktaxonomy_search"] = globalThis["webpackChunktaxonomy_search"] || [];
