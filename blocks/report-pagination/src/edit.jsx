...
function Edit({
	...
	return (
		<Fragment>
			...
			<div {...blockProps} >
				<NextPostButton {...{nextPost, backgroundColor: nextButtonBackgroundColor, textColor: nextButtonTextColor, boxShadowColor: nextButtonBoxShadowColor}} />
				<div className="wp-block-prc-block-report-pagination__pagination">
					<NextPrevButton {...{post: previousPost, label: "&larr; Prev Page"}} />
					<PaginationItems {...{
						paginationItems,
					...
					<NextPrevButton {...{post: nextPost, label: "Next Page &rarr;"}} />
				</div>
			</div>
		</Fragment>
	);
