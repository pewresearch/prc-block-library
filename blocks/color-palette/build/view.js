...
const StyledSlug = _emotion_styled__WEBPACK_IMPORTED_MODULE_1__["default"].span`
	padding: 0px 10px;
	white-space: nowrap;
	`;
function Palette(_ref) {
  ...
  }, hex && !clicked && hex.toUpperCase(), hex && clicked && '\u2713 Copied!', !hex && 'Loading...'), visible && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Popover, {
    placement: "right",
    noArrow: false
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(StyledSlug, null, colorSlug)));
}
