...
function Controls(_ref) {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_4__.InspectorControls, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.__experimentalToolsPanel, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Staff Query Filters'),
    resetAll: () => {
      console.log('Reset All');
    },
    panelId: clientId
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(PanelDescription, null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Use the filters below to filter the staff members that are displayed. Filter by staff type or research area.')), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.__experimentalToolsPanelItem, {
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Filter by Staff Type'),
    hasValue: () => staffType !== undefined,
    onDeselect: () => console.log('onDeselect'),
    resetAllFilter: newAttributes => console.log('reset all', newAttributes),
    panelId: clientId
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_prc_components__WEBPACK_IMPORTED_MODULE_1__.TermSelect, {
    maxTerms: 1,
    value: (0,lodash__WEBPACK_IMPORTED_MODULE_6__.has)(staffType, 'name') ? [{
      value: staffType.name,
      title: staffType.name
    }] : [],
    taxonomy: "staff-type",
    usePrimaryRestAPI: true,
    onChange: term => {
      setAttributes({
        staffType: term
      });
    ...
    label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_3__.__)('Filter by Research Area'),
    ...
    maxTerms: 1,
    value: (0,lodash__WEBPACK_IMPORTED_MODULE_6__.has)(researchArea, 'name') ? [{
...
/* harmony import */ var _query__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./query */ "./src/query.js");
...
function StaffInnerBlocks(_ref) {
  let {} = _ref;
...
function StaffBlockPreview(_ref2) {
  let {
    blocks,
    blockContextId,
    isHidden,
...
const MemoizedStaffBlockPreview = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.memo)(StaffBlockPreview);
const useBlockState = _ref3 => {
  let {
    attributes,
    clientId
  } = _ref3;
  const [activeBlockContextId, setActiveBlockContextId] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
  const setContextId = b => {
    let newContextId = null;
    if (Array.isArray(b)) {
      const firstBlockContext = b[0];
      newContextId = md5__WEBPACK_IMPORTED_MODULE_2___default()(JSON.stringify(firstBlockContext));
    }
    if ('string' === typeof b) {
      newContextId = b;
    }
  ...
  const [staffPosts, setStaffPosts] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)(false);
  const {
    blocks
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    (0,_query__WEBPACK_IMPORTED_MODULE_7__["default"])(attributes).then(newStaffPosts => {
...
const BlockContextProviderMemoized = _ref4 => {
  let {
    blockContexts,
    activeBlockContextId,
    blocks,
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, blockContexts.map((blockContext, index) => {
    const contextId = md5__WEBPACK_IMPORTED_MODULE_2___default()(JSON.stringify(blockContext));
    const isVisible = contextId === activeBlockContextId || contextId === md5__WEBPACK_IMPORTED_MODULE_2___default()(JSON.stringify(blockContexts[0]));
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.BlockContextProvider, {
      ...
      value: blockContext
    }, activeBlockContextId === null || isVisible ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(StaffInnerBlocks, null) : null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(MemoizedStaffBlockPreview, {
      blocks: blocks,
...
function Edit(_ref5) {
  ...
  if (!staffPosts) {
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", blockProps, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_5__.Spinner, {
      style: {
        align: 'center'
      }
    }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", null, "Loading staff members..."));
  }
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_Controls__WEBPACK_IMPORTED_MODULE_6__["default"], {
    attributes,
    setAttributes,
    clientId
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", blockProps, blockContexts && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(BlockContextProviderMemoized, {
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__() {
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_prc_icons__WEBPACK_IMPORTED_MODULE_1__.Icon, {
    icon: _prc_icons__WEBPACK_IMPORTED_MODULE_1__.icons.faUserGear,
    height: 21,
...
function query(_ref) {
  ...
  const endpointUrl = (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_1__.addQueryArgs)(`${window.location.origin}/wp-json/wp/v2/staff`, args);
  return new Promise(resolve => {
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_0___default()({
      url: endpointUrl
    }).then(posts => {
      resolve(posts.map(item => ({
        staffPostId: item.id,
        ...item.staffInfo
      })));
    });
...
"use strict";
module.exports = JSON.parse('{"$schema":"https://schemas.wp.org/trunk/block.json","apiVersion":2,"name":"prc-block/staff-query","version":"0.1.0","title":"Staff Query","category":"theme","description":"Query staff members.","attributes":{"allowedBlocks":{"type":"array"},"staffType":{"type":"object"},"researchArea":{"type":"object"}},"supports":{"anchor":true,"html":false,"spacing":{"blockGap":true,"margin":["top","bottom"],"padding":true},"typography":{"fontSize":true,"__experimentalFontFamily":true}},"textdomain":"bylines-query","editorScript":"file:./index.js","editorStyle":"file:./index.css","style":"file:./style-index.css"}');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkstaff_query"] = self["webpackChunkstaff_query"] || [];
