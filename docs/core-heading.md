...
- **Toolbar:** Adds a "book" icon toggle button to mark/unmark a heading as a chapter
- **Inspector Advanced Controls:** When `isChapter` is true, shows an "Alternate TOC Text" text field
...
<h3 class="wp-block-heading" id="key-findings"
    data-is-section="true"
    data-wp-interactive='{"namespace":"prc-block/table-of-contents"}'
    data-wp-context='{"id":"key-findings"}'>Key Findings</h3>
