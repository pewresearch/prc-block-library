...
1. **Dialog element rendering:** Hooks into `render_block_prc-block/dialog-element` to inject video-related Interactivity API directives:
...
<div class="wp-block-prc-block-dialog is-style-video">
  ...
  <dialog class="wp-block-prc-block-dialog-element"
