...
```html
<section class="wp-block-prc-block-accordion" id="accordion-xyz123"
         data-wp-interactive="prc-block/accordion-controller"
         data-wp-class--is-active="callbacks.isActiveAccordion">
    <h3 class="wp-block-prc-block-accordion__title"
        ...
        <span class="wp-block-prc-block-accordion__title-text">Your Title Here</span>
    </h3>
