...
| Version     | 5.0.0                                                                                                                                                                    |
| Description | A story item is a visual display of a post, with a title, excerpt, and image. Pre-compiled variations such as pub-listing, list-item, and newsletter-glue are available.  |
...
| `excerpt`               | `string`  | _(none)_    | HTML excerpt content. Sourced from `.description` selector, multiline `<p>` tags.               |
...
```html
<article class="wp-block-prc-block-story-item is-style-lede has-image-top has-image-size-a1">
  <div class="meta">
